...
2. If the deliverable is **markdown in docs/** (path like `docs/specs/product-requirements/...`, `docs/specs/use-cases/...`, `docs/invention-disclosures/...`, or `docs/ARCHITECTURE.yaml`) → use **do-work-docs**.
